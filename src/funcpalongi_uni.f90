    ...
    !========================          FUNCPAJ_SPLINES         ====================
        double precision function funcpalongi_uni(b,np,id,thi,jd,thj)
   ...
   !     use ParametresPourParallelisation
    ...
    ! *** NOUVELLLE DECLARATION F90 :
        ...
        !integer ::neval,ifail
        !
        integer::n,j,k,vj,ig,choix,i !l
        !integer,dimension(ngmax)::cpt
        double precision::sum,res !som1,som2,pe1,pe2,vet,vet2,h1
        double precision :: eps_s
    
        !double precision,dimension(-2:npmax):: the1,the2
        double precision,dimension(np)::bh
        double precision,dimension(ngmax):: integrale4
        !,& res2,res1dc,res2dc,res3dc,integrale1,integrale2,integrale3
 ...
 !  use lois_normales
  !    use tailles
    ...
    ! *** NOUVELLLE DECLARATION F90 :
        ...
        integer :: ier
        !
        integer::i,j,k,jj !n,vj,ig,choix,l
            double precision,dimension(np)::bh
          double precision::eps !int
        double precision,parameter::pi=3.141592653589793d0
