   ...
   ! deallocate(ycurrent_all,param_alnorm,s_cag_all,upper_all,cdc_all,aux_all,weights_all)
    ...
    use optim
        ...
        use comon,only:alpha,nig,cdc,sigmae,& !auxig,nmesy
            nea,nb1,etaydc,etayr,& !vedc,nva2,npp,nva3,betaD,etaD,t0dc,t1dc,link
        ...
        double precision :: yscalar,alnorm,prod_cag !eps
        integer :: j,i,k,n,licznik !jj,ier
        ...
        double precision :: func10J !resultdc,abserr,resabs,resasc
    ...
    use optim
        ...
        use comon,only:alpha,nig,cdc,sigmae,& !auxig,nmesy
            ...
            s_cag_id,s_cag,methodGH,b_lme,invBi_chol,matb_chol,nnodes_all,& !ut,utt,vey, typeof
            nodes,weights,yy,it,ziy,mat,det,invBi_cholDet,K_D0,K_G0,lambda,y0,& 
    ...
    use optim
        ...
        use comon,only:alpha,nig,cdc,sigmae,& !nmesy,auxig
            nea,nb1,etaydc,etayr,& !link,nva2,npp,nva3,vedc,betaD,etaD,t0dc,t1dc
            s_cag_id,s_cag,methodGH,b_lme,invBi_chol,matb_chol,nnodes_all,& !vey, typeof,ut,utt,
            nodes,weights,yy,it,ziy,mat,det,invBi_cholDet,K_D0,K_G0,lambda,y0,&
            netar,netadc,RE_which,box_cox_par,box_cox1
        use donnees_indiv
        ...
        double precision :: yscalar,alnorm,prod_cag !eps
        integer :: j,i,k,n,licznik !ier,jj
        double precision,dimension(nea,1)::  Xea2
        double precision,dimension(nea):: uii, Xea22,Xea
        double precision,dimension(1)::uiiui
        logical :: upper
    ...
    use optim
        ...
        use donnees
        use comon,only:alpha,nig,cdc,sigmae,& !auxig,nmesy
            nea,nb1,etaydc,etayr,& !betaD,etaD,t0dc,t1dc,nva2,npp,nva3,vedc,link
            s_cag_id,s_cag,methodGH,b_lme,invBi_chol,matb_chol,nnodes_all,& !vey, typeof,ut,utt
            nodes,weights,yy,it,ziy,mat,det,invBi_cholDet,K_D0,K_G0,lambda,y0,&
            netar,netadc,RE_which,box_cox_par,box_cox1
        use donnees_indiv
