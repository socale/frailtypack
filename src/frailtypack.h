...
void 
F77_SUB(joint_longi)(int *VectNsujet, int *ngnzag, double *k0, 
						double *tt00, double *tt10, int *ic0, int *groupe0, 
						double *tt0dc0, double *tt1dc0, int *icdc0, int *link0, 
						double *yy0, int *groupey0, int *groupeB0, int *Vectnb0, double *matzy0, double *matzB0,
						double *cag0, double *VectNvar, double *vax0,
						double *vaxdc0, double *vaxy0,  double *vaxB0, int *noVar, 
						int *maxit0, int *np, int *neta0, double *b, 
						double *H_hessOut, double *HIHOut, double *resOut, double *LCV, 
						...
						double *ResLongi, double *Pred_y0, int *positionVarTime, 
                        int *numInterac,double *linearpred, 
