...
!noVar = c(noVar1,noVar2,noVar3)
   ...
   !   use ParametresPourParallelisation
    ...
    !AD:
        ...
        integer::maxit0,initialGH !npinit,nvatmp
    ...
    !    integer::typeJoint0
        ...
        integer::groupey,j,ii,iii  & !ij,kk,iii2,cptstr1,cptstr2,nz,n,k
        ,i & !cptni,cptni1,cptni2,nb_echec,nb_echecor,id,cptbiais
        ,ier,istop !cptauxdc,p
        double precision::res,max, & !h,hdc,pord,min,mindc
        rl_temp !! rajout !moy_peh0,moy_peh1,lrs,BIAIS_moy,
    !AD: add for new marq
  ...
  b_pred(1:ng,1:nea+1+nea + (nea*(nea-1))/2) = b_paGH(1:ng,1:nea+1+nea + (nea*(nea-1))/2)
    ...
    use optim
        ...
        use comon,only:sigmae,nb1,& !nmesy,npp,nva3,nea
            s_cag_id,s_cag,methodGH,b_lme,invBi_chol,matb_chol,nnodes_all,& !ut,utt,vey
