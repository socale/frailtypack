...
!========================                  FUNCPA_ADDITIVE (version GENERALISEE)                 ====================
    double precision function funcpasgenadditif(b,np,id,thi,jd,thj,k0)
    ...
    ! call dblepr("Je suis dans la fonction funcpasgenadditif", -1, 0.d0, 1)
	! ###############################################################################
...
123     continue
    ...
    end function funcpasgenadditif
