...
!========================          FUNCPA_CPM_TPS          ====================
    double precision function funcpasgenadditif_param(b,np,id,thi,jd,thj,k0)
...
! *** NOUVELLLE DECLARATION F90 :
    ...
    double precision,external::risqindiv_additif_positif,risqindiv_additif_initial_param
...
!call dblepr("Risque individuel initial", -1, risqindiv_additif_initial_param(t1(i),i,bh,np), 1)
...
!cccccccccccccccccccccc
			...
			if(risqindiv_additif_initial_param(t1(i),i,bh,np) .le. 0.d0) then
			    nbrisqneg = nbrisqneg+1
			    res2pen(g(i)) = res2pen(g(i)) + (risqindiv_additif_initial_param(t1(i),i,bh,np))**2
			endif
...
123     continue
    ...
    end function funcpasgenadditif_param
!====================================================================



!====================================================================
    double precision function risqindiv_additif_initial_param(tps,i,bh,np)
...
!============ fonction de risque
    ...
    !risqindiv_additif_initial_param = bbb+vet
	risqindiv_additif_initial_param = bbb+dlog(vet)
	!if (risqindiv_additif_initial_param.le.0.d0) then
	!    risqindiv_additif_initial_param = 1d-16
    !endif

    return

    end function risqindiv_additif_initial_param
!====================================================================
...
!====================================================================
    double precision function risqindiv_additif_positif_param(tps,i,bh,np)
...
!============ fonction de risque
    ...
    !risqindiv_additif_positif_param = bbb+vet
	risqindiv_additif_positif_param = bbb+dlog(vet)
	if (risqindiv_additif_positif_param.le.0.d0) then
	    risqindiv_additif_positif_param = 1d-16
    endif

    return

    end function risqindiv_additif_positif_param
!====================================================================