...
#'    \item{b}{Sequence of the corresponding estimation of the coefficients for the hazard functions 
#'    (splines parameter s), the power s parameter \eqn{\zeta} (if \code{indice.zeta} is set to \code{1}),
